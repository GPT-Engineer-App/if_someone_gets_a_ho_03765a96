            ...
            <Tr>
              ...
              {players.map((player, playerIndex) => (
                <Td key={playerIndex} isNumeric>
                  <Input type="number" fontWeight={player.scores[currentHole] === 1 ? "bold" : "bold"} color={player.scores[currentHole] === 1 ? "red.500" : "green.500"} value={player.scores[currentHole] === 0 ? "" : player.scores[currentHole]} onChange={(e) => handleScoreChange(playerIndex, currentHole, e.target.value)} size="sm" max={9} />
                </Td>
              ))}
            </Tr>
            <Tr>
                ...
                <Tr key={holeIndex}>
                  ...
                  {players.map((player, playerIndex) => (
                    <Td key={playerIndex} isNumeric color="gray.500">
                      <Input type="number" fontWeight={player.scores[holeIndex] === 1 ? "bold" : "normal"} color={player.scores[holeIndex] === 1 ? "red.500" : "gray.500"} value={player.scores[holeIndex] === 0 ? "" : player.scores[holeIndex]} onChange={(e) => handleScoreChange(playerIndex, holeIndex, e.target.value)} size="sm" max={9} />
                    </Td>
                  ))}
                </Tr>
              );
